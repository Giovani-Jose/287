...
<html>
<head>
    <title>Auberginn</title>
    <meta name="author" content="Vincent Ducharme">
    <meta name="description" content="Page d'accueil de l'application Auberginn">
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="col-md-4 offset-md-4">
        <form action="Login" method="POST">
            <div class="form-group">
                <%--@declare id="useridbd"--%><label for="userIdBD">Nom d'utilisateur de la base de donnée</label>
